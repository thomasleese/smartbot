...
module.exports = function(bot, config) {
  ...
  bot.respond(/remind me (to|about|that) (.*) (in|at) (.*)$/i, function(msg, reply) {
    ...
    if (date && moment(date).isValid()) {
      reply("Sure thing " + msg.from + ", I'll remind you at " + moment(date).format("ddd, MMM Do YYYY, HH:mm:ss") + ".");
      setTimeout(function() {
  ...
  bot.help("remind", function(msg, reply) {
    ...
    reply("Supports relative and absolute times in a human-readable form.");
  });
